...
<div class="row">
    <div class="col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                <h1>Privacy Policy for HiyaMee Pvt Ltd</h1>
                <p>At Hiyamee, accessible from https://hiyameex.com/, one of our main priorities is the privacy of our
                    visitors. This Privacy Policy document contains types of information that is collected and recorded
                    by Hiyamee and how we use it.</p>
                <p>If you have additional questions or require more information about our Privacy Policy, do not
                    hesitate to contact us.</p>
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                    with regards to the information that they shared and/or collect in Hiyamee. This policy is not
                    ...
                    Policy was created with the help of the <a
                        href="https://www.termsfeed.com/privacy-policy-generator/">TermsFeed Privacy Policy
                        Generator</a>.</p>
                <h2>Consent</h2>
                ...
                <h2>Log Files</h2>
                <p>Hiyamee follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <p>Like any other website, Hiyamee uses 'cookies'. These cookies are used to store information including
                ...
                <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Hiyamee.
                </p>
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that appear on Hiyamee, which are sent
                ...
                <p>Note that Hiyamee has no access to or control over these cookies that are used by third-party
                    advertisers.</p>
                <h2>Third Party Privacy Policies</h2>
                <p>Hiyamee's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
                ...
                <p>Hiyamee does not knowingly collect any Personal Identifiable Information from children under the age
