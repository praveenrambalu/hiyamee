    ...
    <div class="col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <p>Welcome to Hiyamee!</p>
                <p>These terms and conditions outline the rules and regulations for the use of HiyaMee Pvt Ltd's
                    Website, located at https://hiyameex.com/.</p>
                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    Hiyamee if you do not agree to take all of the terms and conditions stated on this page.</p>
                ...
                <p>We employ the use of cookies. By accessing Hiyamee, you agreed to use cookies in agreement with the
                    HiyaMee Pvt Ltd's Privacy Policy. </p>
                ...
                <p>Unless otherwise stated, HiyaMee Pvt Ltd and/or its licensors own the intellectual property rights
                    for all material on Hiyamee. All intellectual property rights are reserved. You may access this from
                    Hiyamee for your own personal use subjected to restrictions set in these terms and conditions.</p>
                <p>You must not:</p>
                <ul>
                    <li>Republish material from Hiyamee</li>
                    <li>Sell, rent or sub-license material from Hiyamee</li>
                    <li>Reproduce, duplicate or copy material from Hiyamee</li>
                    <li>Redistribute content from Hiyamee</li>
                </ul>
                <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of
                    the <a href="https://www.termsandconditionsgenerator.com">Terms And Conditions Generator</a>.</p>
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. HiyaMee Pvt Ltd does not filter, edit, publish or review Comments
                    prior to their presence on the website. Comments do not reflect the views and opinions of HiyaMee
                    Pvt Ltd,its agents and/or affiliates. Comments reflect the views and opinions of the person who post
                    their views and opinions. To the extent permitted by applicable laws, HiyaMee Pvt Ltd shall not be
                ...
                <p>HiyaMee Pvt Ltd reserves the right to monitor all Comments and to remove any Comments which can be
                ...
                <p>You hereby grant HiyaMee Pvt Ltd a non-exclusive license to use, reproduce, edit and authorize others
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                    ...
                    the absence of HiyaMee Pvt Ltd; and (d) the link is in the context of general resource information.
                </p>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to HiyaMee Pvt Ltd. Please include your name, your
                ...
                <p>No use of HiyaMee Pvt Ltd's logo or other artwork will be allowed for linking absent a trademark
                    license agreement.</p>
