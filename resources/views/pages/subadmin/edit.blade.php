...
<div class="page-header">
    <div class="header-sub-title">
        <nav class="breadcrumb breadcrumb-dash">
            ...
            <a class="breadcrumb-item" href="/admin/view">Admin</a>
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" pattern="^[6-9]\d{9}$" value="{{$recruiter->phoneno}}" class="form-control"  placeholder="Ex: 9876543210" name="phoneno">
                        </div>
